local KeyToucheCloseEvent = {
    ...
    { code = 177, event = 'Backspace' }, -- PrÃ¸v med numpad
    { code = 96, event = '-' }, -- PrÃ¸v med numpad
    { code = 97, event = '+' }, -- PrÃ¸v med numpad
    { code = 157, event = '1' }, -- PrÃ¸v med numpad
    { code = 158, event = '2' }, -- PrÃ¸v med numpad
    { code = 160, event = '3' }, -- PrÃ¸v med numpad
    { code = 164, event = '4' }, -- PrÃ¸v med numpad
    { code = 165, event = '5' }, -- PrÃ¸v med numpad
    { code = 159, event = '6' }, -- PrÃ¸v med numpad
    { code = 161, event = '7' }, -- PrÃ¸v med numpad
    { code = 162, event = '8' }, -- PrÃ¸v med numpad
    { code = 163, event = '9' }, -- PrÃ¸v med numpad
    { code = 82, event = ',' }, -- PrÃ¸v med numpad
}
        ...
        if ShowNumberNotification == true then
            for _,contact in pairs(contacts) do
                if contact.number == message.transmitter then
                    TriggerEvent("pNotify:SendNotification",{text = "<h3>ðŸ’¬ Besked</h3> <br> <p>Du har modtaget en ny besked fra "..contact.display.. "</p>",type = "info",timeout = (8000),layout = "bottomright",queue = "global",animation = {open = "gta_effects_fade_in", close = "gta_effects_fade_out"}, killer = true})                    contactnotify = true
                    break;
                end
            end
            if contactnotify == false then
                TriggerEvent("pNotify:SendNotification",{text = "<h3>ðŸ’¬ Besked</h3> <br> <p>Du har modtaget en ny besked fra "..message.transmitter.."</p>",type = "info",timeout = (8000),layout = "bottomright",queue = "global",animation = {open = "gta_effects_fade_in", close = "gta_effects_fade_out"}, killer = true})            
            end
        end
        contactnotify = false
...
RegisterNUICallback('notififyUseRTC', function (use, cb)
    ...
    if USE_RTC == true and inCall == true then
        ...
        --exports.mumblevoip_script:removePlayerFromRadio(mumblevoipID)
        --mumblevoipID = nil
